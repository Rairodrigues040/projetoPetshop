...
const equipe = [
  {
    ...
    descricao: 'Adotar mudou minha vida com muito amor, carinho e patinhas pela casa.',
  },
  {
    foto: Rai,
    nome: 'Raí Rodrigues',
    cargo: 'Dev Front-End',
    descricao: 'Cada linha de código aqui é por eles e por um final feliz. Adote!',
  },
  {
    foto: Alice,
    nome: 'Alice Lima',
    cargo: 'UI/UX Designer',
    descricao: 'Tenho dois cachorros adotados e sei bem o quanto essa causa importa!',
  },
  {
    foto: Gustavo,
    nome: 'Gustavo Santos',
    cargo: 'Dev Front-End',
    descricao: 'A energia e a alegria que meus pets trazem pro dia a dia não têm preço. Apoiar essa causa é apoiar o amor em sua forma mais pura.',
  },
];
