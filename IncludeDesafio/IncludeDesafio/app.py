...
import data  # seu módulo para manipular dados
...
def validar_usuarios():
    ...
    try:
        ...
        return jsonify({'mensagem': retorno, 'status': status}), 200
...
@app.route('/animais/listarAnimais', methods=['POST'])
